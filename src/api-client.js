                ...
                for (const line of lines) {
                    ...
                    try {
                        ...
                        if (data.type === 'token') {
                            ...
                            // Reset timeout - tool is running, keep connection alive
                            // Extend to 2 minutes for long-running tools like get_knowledge_base
                            clearTimeout(timeoutId);
                            timeoutId = setTimeout(() => controller.abort(), 120000);
                            window.DebugLogger.log('Tool started:', data.tool_name);
                            // Optionally notify UI about tool execution if needed
